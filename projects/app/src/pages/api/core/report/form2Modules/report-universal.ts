...
import { FormatForm2ModulesProps } from '@fastgpt/global/core/report/api';
...
function simpleChatTemplate(formData: ReportSimpleEditFormType): ModuleItemType[] {
  return [
    {
...
function datasetTemplate(formData: ReportSimpleEditFormType): ModuleItemType[] {
