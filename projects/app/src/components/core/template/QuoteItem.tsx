...
import RawSourceBox from '@/components/core/template/RawSourceBox';
import type { SearchDataResponseItemType } from '@fastgpt/global/core/template/type.d';
      ...
      >
        ...
        {canViewSource && (
          <Flex alignItems={'center'} mt={3} gap={4} color={'myGray.500'} fontSize={'xs'}>
            <MyTooltip label={t('core.template.Quote Length')}>
            ...
            <Box flex={1} />
            {quoteItem.id && (
              <MyTooltip label={t('core.template.data.Edit')}>
                <Box
            ...
            {linkToTemplate && (
              <Link
                ...
                alignItems={'center'}
                color={'primary.500'}
                href={`/template/detail?templateId=${quoteItem.templateId}&currentTab=dataCard&collectionId=${quoteItem.collectionId}`}
              >
                {t('core.template.Go Template')}
