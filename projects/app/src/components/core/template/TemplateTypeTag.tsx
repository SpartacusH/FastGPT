...
import { TemplateTypeMap } from '@fastgpt/global/core/template/constants';

const TemplateTypeTag = ({ type, ...props }: { type: `${TemplateTypeEnum}` } & FlexProps) => {
  const { t } = useTranslation();

  const item = TemplateTypeMap[type];
